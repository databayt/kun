...
`(cd ~/.Codex/skills/clone/scripts && npm run bootstrap)`.

```bash
node ~/.Codex/skills/clone/scripts/clone-capture.mjs \
...
```
Workflow({
  scriptPath: "~/.Codex/skills/clone/scripts/clone.workflow.mjs",
