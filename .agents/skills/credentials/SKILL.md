...
```bash
/Users/abdout/kun/.Codex/scripts/credentials.sh $ARGUMENTS
```
...
1. Run `eval $(/Users/abdout/kun/.Codex/scripts/credentials.sh export)` to load into shell
2. Restart Codex to pick up new MCP connections
