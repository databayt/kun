...
(`~/.Codex/agents/cloudflare.md`). Repo-specific facts for hogwarts live in
`hogwarts/.Codex/rules/cloudflare-deploy.md` and `hogwarts/DEPLOYMENT.md`. This skill is the
