...
4. **Skills** — `pnpm dlx skills add shadcn/ui` drops a _per-repo_ project-aware skill into `.Codex/skills/`. This pack is the always-on user-level umbrella above it.
...
- **Build / customize a primitive** → `shadcn` agent (`~/.Codex/agents/shadcn.md`).
