...
export const topicDetails: Record<string, TopicDetail> = {
  ...
  quality: {
    ...
    usage: [
      ...
      "/handover [block] — 5-pass Playwright QA before client demo",
      "/release [block] — full client handoff: handover → check → ship → watch → notify",
    ],
    configPaths: [
