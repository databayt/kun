...
export const SOCIAL_DICTIONARY = {
  en: {
    ...
    postTypeText: "Text only",
    postTypeImage: "Text + image",
    postTypeGallery: "Text + images",
    postTypeVideo: "Text + video",
    postTypeImageOnly: "Image only",
    postTypeVideoOnly: "Video only",
    postTypeCarousel: "Carousel",
    postTypeStory: "Story",
    postTypeReel: "Reel",
    postTypeHint: "Steers which library assets the ＋ offers.",
    // The byline's second line — where Facebook puts the time. What it says
    // follows the Send setting, because that is what decides when this
    // appears. No audience: a Page posts publicly, so saying so every time
    // is a word that never varies.
    previewWhenNow: "Just now",
    previewWhenLater: "Scheduled",
    ...
    laneHiggs: "Photo",
    laneTemplate: "Designed",
    laneNone: "Placed",
    // And its look, where the taxonomy records one.
    styleMinimal: "Minimal",
    styleCinematic: "Cinematic",
    mediaSeconds: "{count}s",
    ...
    reviewTitle: "Publish",
    // The other two stages' one word, for the same frame. "Draft" and "Media"
    // are what the tab row calls them; a stage heading that renamed its own
    ...
    mediaSpotlightCount: "{shown} of {total}",
    mediaSpotlightAttached: "Attached",
  ...
  ar: {
    ...
    postTypeText: "نص فقط",
    postTypeImage: "نص وصورة",
    postTypeGallery: "نص وصور",
    postTypeVideo: "نص وفيديو",
    postTypeImageOnly: "صورة فقط",
    postTypeVideoOnly: "فيديو فقط",
    postTypeCarousel: "كاروسيل",
    postTypeStory: "ستوري",
    postTypeReel: "ريل",
    postTypeHint: "يوجّه أي أصول المكتبة يعرضها ＋.",
    previewWhenNow: "الآن",
    previewWhenLater: "مجدول",
    ...
    mediaSpotlightCount: "{shown} من {total}",
    mediaSpotlightAttached: "مرفقة",
    reviewNextUp: "التالي",
    reviewAgo: "قبل {age}",
