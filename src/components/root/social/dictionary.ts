...
export const SOCIAL_DICTIONARY = {
  en: {
    ...
    spotlightNoPublished: "Nothing published for this brand yet.",
    spotlightEmptyEverywhere: "Nothing in the queue, for any brand.",
    // The mode row — the split icons in the bar. Labels double as tooltips.
    spotlightModeAll: "All",
    spotlightModeDrafts: "Drafts",
    spotlightModeScheduled: "Scheduled",
    ...
    spotlightConfigTiming: "Destination",
    spotlightConfigPostType: "Post type",
    spotlightConfigMedia: "Media",
    scheduleAction: "Schedule",
    destinationDirect: "Publish now",
    ...
    destinationReview: "Send for review",
    ...
    spotlightConfigBack: "Back to settings",
    spotlightConfigNone: "None",
    // The quick-start row under the boxes.
    spotlightStartTitle: "Start from",
    spotlightStartQueue: "Next in queue",
    spotlightStartQueueHint: "{count} waiting",
    spotlightStartQueueEmpty: "Nothing waiting",
    spotlightStartReuse: "Reuse a post",
    spotlightStartReuseHint: "Last one that went out",
    spotlightStartReuseEmpty: "Nothing published yet",
    spotlightStartBlank: "Blank",
    spotlightStartBlankHint: "Clear and write fresh",
    spotlightStartReused: "Copied in as a starting point — it will publish as a new post.",
    // The third row: what to check before it goes.
    spotlightCheckTitle: "Before it goes",
    spotlightCheckChannels: "Delivery",
    spotlightCheckChannelsReady: "{count} wired and reachable",
    spotlightCheckChannelsDown: "Relay not answering",
    spotlightCheckChannelsNone: "No channel selected",
    spotlightCheckChannelsChecking: "Checking…",
    spotlightCheckCraft: "Craft",
    spotlightCheckCraftClean: "Reads clean",
    spotlightCheckCraftFlags: "{count} to look at",
    spotlightCheckCraftEmpty: "Write something first",
    spotlightCheckCraftSkipped: "Arabic only",
    spotlightCheckWeek: "This week",
    spotlightCheckWeekCount: "{count} went out",
    spotlightScope: "Brands",
    spotlightScopeThis: "Only {brand}",
    spotlightScopeAll: "Every brand",
    spotlightOrder: "Order",
    spotlightOrderOldest: "Oldest first",
    spotlightOrderNewest: "Newest first",
    spotlightMediaOnly: "With media only",
    spotlightRefresh: "Refresh the queue",
    spotlightGoesOut: "goes out {when}",
    spotlightWentOut: "published {when}",
    spotlightTurn: "v{turn}",
    spotlightReadOnly: "Read-only — opens the ledger",
    // Footer key hints.
  ...
  ar: {
    ...
    spotlightNoPublished: "لم يُنشر شيء لهذه العلامة بعد.",
    spotlightEmptyEverywhere: "لا شيء في الطابور، لأي علامة.",
    spotlightModeAll: "الكل",
    spotlightModeDrafts: "المسودات",
    ...
    spotlightConfigBack: "عودة للإعدادات",
    spotlightConfigNone: "لا شيء",
    spotlightStartTitle: "ابدأ من",
    spotlightStartQueue: "التالي في الطابور",
    spotlightStartQueueHint: "{count} بانتظار",
    spotlightStartQueueEmpty: "لا شيء بانتظار",
    spotlightStartReuse: "أعد استخدام منشور",
    spotlightStartReuseHint: "آخر ما نُشر",
    spotlightStartReuseEmpty: "لم يُنشر شيء بعد",
    spotlightStartBlank: "من الصفر",
    spotlightStartBlankHint: "امسح واكتب جديداً",
    spotlightStartReused: "نُسخ كنقطة بداية — سيُنشر كمنشور جديد.",
    spotlightCheckTitle: "قبل أن ينشر",
    spotlightCheckChannels: "التسليم",
    spotlightCheckChannelsReady: "{count} موصولة وجاهزة",
    spotlightCheckChannelsDown: "الناقل لا يستجيب",
    spotlightCheckChannelsNone: "لا قناة مختارة",
    spotlightCheckChannelsChecking: "جارٍ الفحص…",
    spotlightCheckCraft: "الصياغة",
    spotlightCheckCraftClean: "تقرأ نظيفة",
    spotlightCheckCraftFlags: "{count} للنظر فيها",
    spotlightCheckCraftEmpty: "اكتب شيئاً أولاً",
    spotlightCheckCraftSkipped: "للعربية فقط",
    spotlightCheckWeek: "هذا الأسبوع",
    spotlightCheckWeekCount: "{count} نُشرت",
    spotlightScope: "العلامات",
    spotlightScopeThis: "{brand} فقط",
    spotlightScopeAll: "كل العلامات",
    spotlightOrder: "الترتيب",
    spotlightOrderOldest: "الأقدم أولاً",
    spotlightOrderNewest: "الأحدث أولاً",
    spotlightMediaOnly: "ما يحمل وسائط فقط",
    spotlightRefresh: "حدّث الطابور",
    spotlightGoesOut: "ينشر {when}",
    spotlightWentOut: "نُشر {when}",
    spotlightTurn: "ن{turn}",
