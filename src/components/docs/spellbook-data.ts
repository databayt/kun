  ...
  },
  {
    ...
    spells: [
      ...
      },
      {
        name: "contact gap",
        effect:
          "The measurement that governs everything: 175 contactable · 13 FB pages · 27 websites · 2,941 name-and-map-pin-only",
        order: [
          f("lead"),
          s("/scrape"),
          p("Keychain"),
