...
export const schools: School[] = [
  ...
  },
  {
    ...
    spells: [
      ...
      { name: "handover", effect: "Pre-demo multi-pass QA — bug-free, flow, responsive, RTL, translation", order: [f("quality"), p("Browser"), s("/handover")], steps: ["Discover routes in the block", "Five passes per route at 375/768/1440", "Capture console + network + a11y", "Verify RTL mirror + translation completeness", "Report: BLOCKED or READY FOR DEMO"], connects: ["e2e", "check", "test", "release"], depends: [] },
