...
| --------------- | -------------------------- | ------------------------------------------------------------------------------------------ |
| Framework       | Next.js                    | 16.3 — AGENTS.md + first-party Skills + official MCP server (agent-native as of Jun 2026)  |
| UI Library      | React                      | 19.2.3                                                                                     |
| Language        | TypeScript                 | 6.0 — 7.0 native (Go, ~10× faster) stable 2026-07-08; adopt at 7.1 when the JS API returns |
| Styling         | Tailwind CSS               | 4.3                                                                                        |
| Database        | Prisma + Neon (PostgreSQL) | 6.19 — maintenance tail; current major is 7.x (needs a `/decide` + `/package` migration)   |
...
Exact versions per repository as of July 2026 (spot-refreshed by `/sync`; full audit via `/package`).
