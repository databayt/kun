...
| Item              | Plan                                              |
| ----------------- | ------------------------------------------------- |
| **Primary**       | Max 5x — $100/mo, for the time being (2026-06-12) |
...
| ------------------ | ---------------------- | ------------ | ------------------------------------ |
| **Now**            | Max 5x (1 seat)        | $100         | Current — "for the time being"       |
| **Headroom**       | Max 20x (1 seat)       | $200         | When Max 5x usage caps bite weekly   |
| **Team grows**     | + Pro seats ($20/each) | $160+        | When Ali/Samia need own accounts     |
