...
graph TD
    ...
    Q1["Every photo that was never mastered<br/>joins the queue"]
    W["It waits its turn"]
...
queue — 1,093 photos are in it today. They come out one at a time, because the
...
> **Every step is live**, except the last mile: writing a mastered photo to its
> proper name needs one AWS permission line widened, or it lands nowhere. What
> is *not* proven yet is how many photos survive the check — see the measured
> trace below.
