...
graph TD
    ...
    S3["We find a home while scouting"]
...
| Step | In plain words |
| --- | --- |
| **A home arrives** | Three ways: a host signs up on mkan.sd and adds it, you write it into Slack `#mkan`, or we find it while scouting. A home added on the website appears on the board within the hour — its host and photos too — with nobody copying anything. The Slack lane is the newest and still being built. |
