...
| **3 · The photo lands in `mkan/inbox`** | The signal pulls the photo down to one folder on the Mac, and puts it on your clipboard ready to paste. |
| **4 · You paste it into ChatGPT** | ⌘V, Enter. You do not type a prompt — the project already carries it (see below). |
...
> timer that would run it is written but not installed. Boxes 5 → 6 are live
...
ChatGPT → **Projects** → New project → name it **Makan Mastering** →
