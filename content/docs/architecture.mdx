...
### Agent Fleet (49 agents, two plugins)
...
| Fleet | Plugin | Agents |
|-------|--------|--------|
| **Company** (22) | `kun-company` | captain, revenue, growth, support, analyst, product, tech-lead, ops, guardian, quality, record, report, analyze, learn, package, clone, transcribe, adjudicate, hogwarts, souq, mkan, shifa |
