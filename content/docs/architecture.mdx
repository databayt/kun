...
| Member | Primary | Mobile | Role |
|--------|---------|--------|------|
| **Osman Abdout** | MacBook M4 (CLI) | iPhone 16e | Engineering lead |
| **Ali Aseel** | Windows (Desktop/Web) | Android | Business & operations |
| **Samia Hamd** | Dell Windows (Desktop, screen reader) | iPhone 13 Mini (VoiceOver) | Content & research |
| **Osman Sedon** | HP Windows (Desktop/Web) | Android | Engineering (part-time) |
...
| Member | Surface | Primary Workflows |
|--------|---------|-------------------|
| **Osman A.** | CLI (MacBook) | dev → build → push → deploy |
| **Ali** | Cowork (Windows) | Client outreach, proposals, financial tracking |
| **Samia** | Cowork (Windows, screen reader) | Arabic content, documentation, research |
| **Sedon** | Desktop/Web (Windows) | Assigned tasks, fix → push |
...
| Accessibility | Screen reader compatibility, VoiceOver testing (Samia) |
...
**Rationale**: Fits $1K/month budget. Add Pro seats ($20) when revenue grows.
