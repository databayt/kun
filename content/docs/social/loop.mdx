...
| Box | In plain words |
| --- | --- |
| **1 · Pick** | *Monday 07:00.* Reads this week's briefs from the content pillars and files one ask per brand — four brands, two topics each. Runs on this Mac. |
| **2 · Write** | *Every 60 seconds.* An agent answers each ask on the Max plan: Arabic written natively, English mirrored from it. Costs nothing per draft. Runs on this Mac. |
| **3 · Check** | *With the draft.* Runs the craft rules — register, length, hollow phrases, and any number that was not in the brief. Today it **advises** rather than refuses. |
| **4 · Approve** | *Once a week, whenever you sit down.* You open the queue, read what was written, and say yes — publish now, or pick a time. **This is the only human step, and the only one with no timer on it.** |
| **5 · Send** | *Every 15 minutes.* Delivers to the brand's Facebook page. Retries up to three times and never double-posts. Runs on GitHub Actions, so it keeps going with the laptop shut. |
| **6 · Measure** | *Every 6 hours.* Reads reach, views, reactions, comments and shares back from Facebook. Also GitHub Actions. |
| **7 · Report** | *Friday 09:00.* A digest in Slack: what was planned, what shipped, the numbers, and **what is still waiting on you**. Runs on this Mac. |
