...
| **Publish** | **Egress layer** — Telegram + Facebook direct APIs · other channels via the [Hermes](/docs/hermes) gateway | Egress only — dumb relays, never the LLM |
...
- **Still pending** — adapters beyond Slack (see [Hermes](/docs/hermes)), persistence
  (`SocialPost`) and therefore real scheduling, per-brand Telegram/Slack channels, and metrics
  pull-back — tracked in `docs/SOCIAL-AUTOMATION.md`.
