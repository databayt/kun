...
The seventeen steps below all happen on **`/social/publish`** — this is that one page,
opened up. Eleven of them are yours — 1 to 7, then 11 to 14 — and every one of those is a
tap or a few words.
...
graph TD
    ...
    S6["6 · Say the topic<br/>(or press one from /social/calendar)"]
    S7["7 · Press Write it"]
    ...
    S13["13 · Attach a photo or a video<br/>(the tray, or /social/media)"]
    S14["14 · Say when"]
    S15["15 · It posts to<br/>your channels"]
    S16["16 · It saves the receipt"]
    S17["17 · It reads the numbers back<br/>(shown on /social/measure)"]
