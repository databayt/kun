...
- **The Google lane is unfunded until a key exists** — the work is wired, the spend is not
  authorised. It is also new external API spend, which the subscription-only billing posture
  says is Abdout's call, not a session's.
