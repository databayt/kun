...
description: Functional + non-functional requirements per phase
---

{/* Generated from docs/PRD.md by scripts/generate-public-docs.sh. Edit the source, not this file. */}
