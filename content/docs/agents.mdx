---
title: Agents
description: 49 agents in two fleets — 22 company, 27 stack
---

# Agents

The engine ships **49 agents** in two fleets. The **company fleet** (22) runs the business: strategy, revenue, quality, product references, product flow videography, and curriculum content. The **stack fleet** (27) writes the code: one agent per framework, layer, or tool.

Each fleet is a plugin, which is how it reaches other machines — see [Onboarding](/docs/onboarding).

| Fleet | Plugin | Agents | Lives in |
|-------|--------|--------|----------|
| Company | `kun-company` | 22 | `.claude/agents/` |
