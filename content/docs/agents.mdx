...
| Agent | Scope |
|-------|-------|
| **captain** | CEO brain — weekly allocation, revenue strategy, team coordination across the products and 7 humans. Never writes code. Always delegates. |
...
```bash
# Full agent fleet installed to ~/.claude/agents/
