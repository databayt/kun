...
```bash
curl -fsSL https://raw.githubusercontent.com/databayt/codebase/main/.claude/scripts/install.sh | bash && ~/.claude/scripts/setup-secrets.sh 68453b25fa9d28c94426c55c179b3838
```

### Windows (PowerShell)

```powershell
irm https://raw.githubusercontent.com/databayt/codebase/main/.claude/scripts/install.ps1 | iex; & "$env:USERPROFILE\.claude\scripts\setup-secrets.ps1" -GistId 68453b25fa9d28c94426c55c179b3838
```
...
**macOS / Linux**
```bash
~/.claude/scripts/setup-secrets.sh 68453b25fa9d28c94426c55c179b3838
```

**Windows**
```powershell
& "$env:USERPROFILE\.claude\scripts\setup-secrets.ps1" -GistId 68453b25fa9d28c94426c55c179b3838
```
...
└── scripts/
    ...
    ├── setup-secrets.sh        # macOS/Linux secrets setup
