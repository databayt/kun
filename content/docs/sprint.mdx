...
- ✅ Wire `postSalaryPayment` to the ledger on disbursement — done 2026-06-21 (salary posting rule rebalanced + wired in `processPayments`; all 6 posters now wired)
