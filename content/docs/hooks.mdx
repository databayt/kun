---
title: Hooks
description: Ten lifecycle automations the engine can't forget to run
---
...
**10 hooks across 6 events**, configured in `.claude/settings.json`.
...
| `session-media-stale.sh` | Staleness check on recorded product media |
