...
- **CRM**: [sijillee.crm.databayt.org](https://sijillee.crm.databayt.org)
- **Status**: planned (pre-launch)
- **Catalog**: the public product catalog at [databayt.org/en](https://www.databayt.org/en) lists everything, including projects not yet uploaded to GitHub

### moallimee

New product — repo not yet in the org. CRM workspace is live.

- **CRM**: [moallimee.crm.databayt.org](https://moallimee.crm.databayt.org)
- **Status**: planned (pre-launch)
- **Catalog**: [databayt.org/en](https://www.databayt.org/en)
...
- **URL**: [github.com/databayt/android-app](https://github.com/databayt/android-app)
- **Stack**: Kotlin, Jetpack Compose
- **Architecture**: Mirrors ios-app module structure
...
Marketing website — the public catalog at [databayt.org](https://www.databayt.org/en) lists every product and project, including ones not yet uploaded to GitHub (some mobile app links still pending).
...
- **URL**: [github.com/databayt/lab](https://github.com/databayt/lab)

### spma

Internal tool.

- **URL**: [github.com/databayt/spma](https://github.com/databayt/spma)
...
| `like sijillee` | Reference sijillee (repo pending — CRM + catalog only) |
| `like moallimee` | Reference moallimee (repo pending — CRM + catalog only) |
