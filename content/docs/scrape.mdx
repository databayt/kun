...
| --------------- | --------: | ----: | ----------------------------------------------- |
| **CONTACTABLE** |   **175** |  5.5% | reachable today                                 |
| FB_PAGE         |        13 |  0.4% | scrape the About/Intro tab                      |
| WEBSITE         |        27 |  0.9% | fetch + extract                                 |
| **MAP_ONLY**    | **2,941** | 93.2% | **an OSM name and a map pin. No automated lane.** |

So: **automated enrichment caps at +40 rows**, and a full scrape run adds **+15** (505 of the
scraper's 817 names were already in the CRM). Meanwhile **130 tier-A/B schools are contactable and
completely unworked**.
...
- **Only 45 of the 175 contacts are mobile.** The rest are switchboards. A landline in a WhatsApp
...
| `leads` · `عملاء محتملين`                 | The 130 contactable tier-A/B schools, unworked                        |
| `prospect`                                | Work one named school — tier, stage, next action                     |
| `enrich` · `جمع بيانات`                   | Signal → contact. FB About + website. Ceiling +40                     |
