...
this Mac, the backend answers at the Tailscale Funnel `https://crm-api.databayt.org`. The
...
**Two install traps, both hit for real.** `uv tool install agent-reach` fetches the **wrong
