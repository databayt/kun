...
- [Company Profile](company_databayt.md) — Team of 4, $1K target
- [User Profile](user_osman.md) — Founder, MacBook M4
  ...
  "team": [
    {
      ...
      "equipment": { "laptop": "MacBook Pro M4", "phone": "iPhone 16e" },
      "strengths": ["architecture", "full-stack", "infrastructure"]
    }
  ]
}
```

This allows agents to tailor their output to each team member's capabilities and tools.
