...
```
                        ...
                        │  Cloudflare ── kun + balqalam + mkan.sd  │
...
| **Cloudflare** | The deploy plane since 2026-09 — Workers + Containers for hogwarts, mkan and kun (`scripts/deploy-cloudflare.sh` in each repo); Vercel's free account is paused for Hobby usage and still serves the databayt.org DNS until the zone moves |
