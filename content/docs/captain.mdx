---
title: Captain
description: CEO brain — delegates across the kun engine and the 4-human databayt team
---
...
**v4 upgrade** (April 2026): captain ships with persistent memory (`captain_journal.md` auto-loaded every session), a deterministic [decision matrix](https://github.com/databayt/kun/blob/main/.claude/captain/decision-matrix.yaml) (24 rules across escalate / act / delegate), live runway tracking, and Anthropic Routines for autonomous weekly cycles. See [EPICS-V4.md](/docs/epics-v4) for the full v4 roadmap.
