...
| Agent | Scope |
|-------|-------|
| captain | CEO brain — weekly allocation, revenue strategy, team coordination across the products and 7 humans |
...
> The canonical installer is `setup.sh`, which installs the full `mcp.json` for everyone.
