...
$$\text{Overall Score} = 0.40 \times \text{Tech} + 0.30 \times \text{Capability} + 0.15 \times \text{Domain} + 0.15 \times \text{Seniority} - \text{Penalty}_{\text{Blocker}}$$
...
| :--- | :--- | :--- | :--- |
| **High Priority** | $\ge 85\%$ (0 blockers) | Perfect alignment with demonstrated builder capabilities | Push to CRM immediately & tailor application |
...
| **Low Probability** | $< 55\%$ or $\ge 2$ blockers | Fundamental mismatch in core stack or domain | Skip or archive |
...
| **Throttling** | $\ge 700\text{ms}$ spacing, exponential backoff on 429 |
