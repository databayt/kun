---
title: Team
description: 8 humans, one shared engine — universal config, one login everywhere
---

# Team

8 humans with one shared engine. Every machine gets the full config; identity is one login (`<name>@databayt.org`) that works across the CRM workspaces and Slack.
