---
title: Team
description: Eight people, one engine — every machine carries the full config, one login opens every workspace
---

Eight of us, one shared engine. Every machine gets the full config, and identity is a single login (`<name>@databayt.org`) that works across the CRM workspaces and Slack.
...
Executive leadership, business strategy, capital allocation, and organization operations. Two decades of building the systems institutions actually run on: technical director of Sudan's national data-exchange platform (40+ institutions, 78+ digital services, 155K+ requests processed), architect of the passport booking system serving 40+ global offices with 674K+ bookings, and lead on the sovereignty-tier foreigners management system spanning 85+ international offices. Earlier: CTO of a telecom and digital services company, IT manager in Saudi Arabia where he founded the function from zero, and systems developer in industrial and national-training settings.

Founder of a bank notification platform that grew to 95K+ users and 1.6M+ processed notifications — self-funded, no growth budget, monetized by solving a real recurring pain. That is the motion he brings to the products: business first, technology as the means. Simplicity as the foundation of anything that scales, data over impressions, and every release improving the product rather than ending it. He knows the market on both sides — Sudan and Saudi Arabia, public sector and commercial — so procurement cycles, government-grade requirements, and the humans inside the institutions are default assumptions here, not late-stage surprises.
